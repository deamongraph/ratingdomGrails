	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="twitterUser-label" class="property-label"><g:message code="user.twitterUser.label" default="Twitter User" /></span>
					
						<span class="property-value" aria-labelledby="twitterUser-label"><g:fieldValue bean="${userInstance}" field="twitterUser"/></span>
				...
				<li class="fieldcontain">
					<span id="company-label" class="property-label"><g:message code="user.company.label" default="Company" /></span>
						...
						<span class="property-value" aria-labelledby="company-label"><g:formatBoolean boolean="${userInstance?.company}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${userInstance?.dataTwitters}">
				<li class="fieldcontain">
					<span id="dataTwitters-label" class="property-label"><g:message code="user.dataTwitters.label" default="Data Twitters" /></span>
					
						<g:each in="${userInstance.dataTwitters}" var="d">
						<span class="property-value" aria-labelledby="dataTwitters-label"><g:link controller="dataTwitter" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></span>
						</g:each>
